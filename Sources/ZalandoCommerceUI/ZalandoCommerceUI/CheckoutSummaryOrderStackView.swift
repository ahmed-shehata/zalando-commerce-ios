...
extension CheckoutSummaryOrderStackView {
    ...
    fileprivate dynamic func saveImageButtonPressed() {
        ZalandoCommerceUIViewController.presented?.prepareSubviewsForScreenshot()
        UIView.waitForUIState {
            let screenshot = ZalandoCommerceUIViewController.presented?.mainNavigationController.view.takeScreenshot()
            ZalandoCommerceUIViewController.presented?.cleanupSubviewsAfterScreenshot()
