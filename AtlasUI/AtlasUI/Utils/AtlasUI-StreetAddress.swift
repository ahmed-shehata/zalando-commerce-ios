...
extension StreetAddress {
    ...
    internal func prefixedAddressLine1(localizedWith localizer: Localizer) -> String {
    ...
    internal func prefixedAddressLine2(localizedWith localizer: Localizer) -> String {
    ...
    internal func prefixedShortAddressLine(localizedWith localizer: Localizer) -> String {
