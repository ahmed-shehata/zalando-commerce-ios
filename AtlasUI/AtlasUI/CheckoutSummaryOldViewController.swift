...
final class CheckoutSummaryOldViewController: UIViewController, CheckoutProviderType {
    ...
    private func setupNavBar() {
        ...
        let cancelButton = UIBarButtonItem(title: loc("Cancel"), style: UIBarButtonItemStyle.Plain,
            target: self, action: #selector(CheckoutSummaryOldViewController.cancelCheckoutTapped(_:)))
    ...
    private func setupButtons() {
        ...
        connectToZalandoButton.addTarget(self, action: #selector(CheckoutSummaryOldViewController.connectToZalandoButtonTapped(_:)),
            forControlEvents: .TouchUpInside)
        view.addSubview(buyButton)
        buyButton.hidden = true
        buyButton.setTitle(loc("Buy Now"), forState: .Normal)
        buyButton.addTarget(self, action: #selector(CheckoutSummaryOldViewController.buyButtonTapped(_:)),
            forControlEvents: .TouchUpInside)
    }
