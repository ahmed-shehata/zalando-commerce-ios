...
struct AddressActionsHandler {
    ...
    func createAddress() {
        viewController?.addressCreationStrategy?.addressFormActionHandler?.completion = { equatableAddress in
            guard let userAddress = equatableAddress as? UserAddress else { return }
